        ...
        <div class="content">
          <section class="terms-section">
            <div class="terms-top-text">
              <h1 class="terms-heading">{lang === "en"? 'Terms': "Villkor"}</h1>
              <button class="go-back-button lower-back-button" onclick="window.close('', '_self', '');history.back()">{lang === "en"? `Close and Go Back`:`Stäng och gå tillbaka`}</button> </div>
            <div class="back-terms">{terms}</div>
            <div class="terms-top-text">
              <button class="go-back-button lower-back-button" onclick="window.close('', '_self', '');history.back()">{lang === "en"? `Close and Go Back`:`Stäng och gå tillbaka`}</button>
            </div>
          </section>
        </div>
      </div>
